...
//Array to contain all the open paths in the current selection.
...
//Retract the first and last handles from all of the paths in the openPaths array.

for(i=openPaths.length-1;i>=0;i--){
	var lastPoint=openPaths[i].pathPoints.length-1;
	openPaths[i].pathPoints[lastPoint].rightDirection=openPaths[i].pathPoints[lastPoint].anchor;
openPaths[i].pathPoints[0].leftDirection=openPaths[i].pathPoints[0].anchor;
}
